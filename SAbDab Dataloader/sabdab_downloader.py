...
def getpdb(pdb_entry, out_path):
    ...
    urllib.request.urlretrieve("http://opig.stats.ox.ac.uk/webapps/abdb/web_front/data/entries/%s/structure/%s.pdb"%(pdb_entry,pdb_entry), out_file)
...
if __name__ == "__main__":
    ...
    for pdb_entry in data:
        ...
        if args.original_pdb or args.chothia_pdb:
            ...
            struc_out_path = '/content/Data/SAbDab/'
